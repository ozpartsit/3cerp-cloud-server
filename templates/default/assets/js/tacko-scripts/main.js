...
(function ($) {
  ...
  function counter_items() {
    ...
    $(".counter-section .counter-store").jQuerySimpleCounter({
      end: 733,
      duration: 8000,
    });
    $(".counter-section .counter-rewards").jQuerySimpleCounter({
      end: 100,
      duration: 8000,
    });
    $(".counter-section .counter-country").jQuerySimpleCounter({
      end: 25,
      duration: 8000,
    });
  }
